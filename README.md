# Starfiles-JSDelivr
This repository is a dump of custom javascript files Starfiles uses. Obviously, not all javascript files used by Starfiles are listed here, only select ones are.
